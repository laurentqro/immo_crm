...
class SettingsController < ApplicationController
  ...
  SETTING_CATEGORIES = {
    ...
    "total_employees_fte" => "entity_info",
    "card_holder_is_legal_entity" => "entity_info",
    "staff_total" => "entity_info",
    "staff_compliance" => "entity_info",
    "uses_external_compliance" => "entity_info",
    "is_foreign_subsidiary" => "entity_info",
    "parent_company_country" => "entity_info",
    "last_external_audit" => "entity_info",
    "applies_aml_risk_ratings" => "kyc_procedures",
    "high_risk_cdd_frequency" => "kyc_procedures",
    "standard_cdd_frequency" => "kyc_procedures",
  ...
  def settings_params
    params.expect(settings: [
      ...
      :last_external_audit,
      :applies_aml_risk_ratings,
      :high_risk_cdd_frequency,
      :standard_cdd_frequency,
      :edd_for_peps,
