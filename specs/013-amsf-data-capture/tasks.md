...
- [ ] T001 Add new enum constants to app/models/concerns/amsf_constants.rb (DUE_DILIGENCE_LEVELS, RELATIONSHIP_END_REASONS, PROFESSIONAL_CATEGORIES, PROPERTY_TYPES, TENANT_TYPES, TRAINING_TYPES, TRAINING_TOPICS, TRAINING_PROVIDERS, MANAGED_PROPERTY_TYPES)
- [ ] T002 [P] Create migration db/migrate/xxx_add_compliance_fields_to_clients.rb (due_diligence_level, simplified_dd_reason, relationship_end_reason, professional_category, source_of_funds_verified, source_of_wealth_verified)
- [ ] T003 [P] Create migration db/migrate/xxx_add_compliance_fields_to_transactions.rb (property_type, is_new_construction, counterparty_is_pep, counterparty_country, rental_annual_value, rental_tenant_type)
- [ ] T004 [P] Create migration db/migrate/xxx_add_verification_fields_to_beneficial_owners.rb (source_of_wealth_verified, identification_verified)
- [ ] T005 [P] Create migration db/migrate/xxx_add_lifecycle_fields_to_submissions.rb (current_step, locked_by_user_id, locked_at, generated_at, reopened_count)
- [ ] T006 [P] Create migration db/migrate/xxx_add_override_tracking_to_submission_values.rb (override_reason, override_user_id, previous_year_value)
- [ ] T007 [P] Create migration db/migrate/xxx_create_managed_properties.rb with indexes per data-model.md
- [ ] T008 [P] Create migration db/migrate/xxx_create_trainings.rb with indexes per data-model.md
- [ ] T009 Run bin/rails db:migrate to apply all schema changes
...
- [ ] T010 [P] Write failing test for ManagedProperty model validations in test/models/managed_property_test.rb
- [ ] T011 [P] Write failing test for Training model validations in test/models/training_test.rb
- [ ] T012 [P] Write failing test for Client compliance field validations in test/models/client_test.rb
- [ ] T013 [P] Write failing test for Transaction compliance field validations in test/models/transaction_test.rb
- [ ] T014 [P] Write failing test for SubmissionValue override validation in test/models/submission_value_test.rb
- [ ] T015 [P] Write failing test for Submission lifecycle methods in test/models/submission_test.rb

### Implementation for Foundational Models

- [ ] T016 [P] Implement ManagedProperty model in app/models/managed_property.rb with validations, scopes (active, active_in_year, for_organization)
- [ ] T017 [P] Implement Training model in app/models/training.rb with validations, scopes (for_year, for_organization, by_type)
- [ ] T018 [P] Add compliance field validations to app/models/client.rb (due_diligence_level, simplified_dd_reason, relationship_end_reason, professional_category)
- [ ] T019 [P] Add compliance field validations to app/models/transaction.rb (property_type, counterparty_country, rental_tenant_type)
- [ ] T020 [P] Add override validation to app/models/submission_value.rb (override_reason required when overridden)
- [ ] T021 Add lifecycle methods to app/models/submission.rb (lock!, unlock!, reopen!, generated?, lockable?)
- [ ] T022 Add fixtures for ManagedProperty in test/fixtures/managed_properties.yml
- [ ] T023 Add fixtures for Training in test/fixtures/trainings.yml
- [ ] T024 Run bin/rails test test/models/ to verify all model tests pass

**Checkpoint**: Foundation ready - user story implementation can now begin

---

## Phase 3: User Story 1 - Submit Annual Survey with Pre-Calculated Data (Priority: P1) 🎯 MVP
...
- [ ] T025 [P] [US1] Write failing test for extended CalculationEngine in test/services/calculation_engine_test.rb (managed_property_statistics, training_statistics, revenue_statistics, extended_client_statistics)
- [ ] T026 [P] [US1] Write failing test for YearOverYearComparator in test/services/year_over_year_comparator_test.rb
- [ ] T027 [P] [US1] Write failing controller test for 7-step wizard in test/controllers/submission_steps_controller_test.rb
- [ ] T028 [US1] Write failing system test for wizard flow in test/system/submission_wizard_test.rb

### Implementation for User Story 1

- [ ] T029 [US1] Extend app/services/calculation_engine.rb with managed_property_statistics method
- [ ] T030 [US1] Extend app/services/calculation_engine.rb with training_statistics method
- [ ] T031 [US1] Extend app/services/calculation_engine.rb with revenue_statistics method (a3802, a3803, a3804, a381)
- [ ] T032 [US1] Extend app/services/calculation_engine.rb with extended_client_statistics method (a11301, a11302, a1203, a1203D)
- [ ] T033 [US1] Create app/services/year_over_year_comparator.rb with comparison_for and significant_changes methods
- [ ] T034 [P] [US1] Create app/components/statistic_card_component.rb for displaying single calculated value with source
- [ ] T035 [P] [US1] Create app/components/statistic_group_component.rb for grouping related statistics
- [ ] T036 [US1] Extend app/controllers/submission_steps_controller.rb VALID_STEPS constant to (1..7)
- [ ] T037 [US1] Implement show_step_1 (Activity Confirmation) in app/controllers/submission_steps_controller.rb
- [ ] T038 [US1] Implement show_step_2 (Client Statistics) with YoY comparison in app/controllers/submission_steps_controller.rb
- [ ] T039 [US1] Implement show_step_3 (Transaction Statistics) with YoY comparison in app/controllers/submission_steps_controller.rb
- [ ] T040 [US1] Implement show_step_4 (Training & Compliance) with YoY comparison in app/controllers/submission_steps_controller.rb
- [ ] T041 [US1] Implement show_step_5 (Revenue Review) with YoY comparison in app/controllers/submission_steps_controller.rb
- [ ] T042 [US1] Implement show_step_6 (Policy Confirmation) in app/controllers/submission_steps_controller.rb
- [ ] T043 [US1] Implement show_step_7 (Review & Sign) with validation warnings in app/controllers/submission_steps_controller.rb
- [ ] T044 [P] [US1] Create app/views/submission_steps/step_1.html.erb (Activity Confirmation view)
- [ ] T045 [P] [US1] Create app/views/submission_steps/step_2.html.erb (Client Statistics view)
- [ ] T046 [P] [US1] Create app/views/submission_steps/step_3.html.erb (Transaction Statistics view)
- [ ] T047 [P] [US1] Create app/views/submission_steps/step_4.html.erb (Training & Compliance view)
- [ ] T048 [P] [US1] Create app/views/submission_steps/step_5.html.erb (Revenue Review view)
- [ ] T049 [P] [US1] Create app/views/submission_steps/step_6.html.erb (Policy Confirmation view)
- [ ] T050 [P] [US1] Create app/views/submission_steps/step_7.html.erb (Review & Sign view with signatory fields)
- [ ] T051 [US1] Implement update_step_7 with XBRL generation in app/controllers/submission_steps_controller.rb
- [ ] T052 [US1] Update app/policies/submission_policy.rb with generate? and reopen? methods (FR-030, FR-031)
- [ ] T053 [US1] Run bin/rails test to verify all US1 tests pass

**Checkpoint**: User Story 1 complete - wizard functional with pre-calculated values and XBRL generation

---

## Phase 4: User Story 2 - Capture Compliance Data During Client Onboarding (Priority: P2)
...
- [ ] T054 [P] [US2] Write failing controller test for client compliance fields in test/controllers/clients_controller_test.rb
- [ ] T055 [P] [US2] Write failing system test for client form in test/system/clients_test.rb

### Implementation for User Story 2

- [ ] T056 [US2] Update app/controllers/clients_controller.rb strong params to permit new compliance fields
- [ ] T057 [US2] Update app/views/clients/_form.html.erb with due_diligence_level dropdown (FR-001)
- [ ] T058 [US2] Update app/views/clients/_form.html.erb with simplified_dd_reason field (conditional on SIMPLIFIED)
- [ ] T059 [US2] Update app/views/clients/_form.html.erb with professional_category dropdown (FR-002)
- [ ] T060 [US2] Update app/views/clients/_form.html.erb with source_of_funds_verified checkbox (FR-004)
- [ ] T061 [US2] Update app/views/clients/_form.html.erb with source_of_wealth_verified checkbox (FR-004)
- [ ] T062 [US2] Update app/views/clients/_form.html.erb with relationship_end_reason dropdown (FR-003)
- [ ] T063 [US2] Add Stimulus controller for conditional simplified_dd_reason visibility in app/javascript/controllers/
- [ ] T064 [US2] Run bin/rails test to verify all US2 tests pass

**Checkpoint**: User Story 2 complete - client compliance data captured during onboarding

---

## Phase 5: User Story 3 - Record Property Management Contracts (Priority: P2)
...
- [ ] T065 [P] [US3] Write failing controller test for managed_properties in test/controllers/managed_properties_controller_test.rb
- [ ] T066 [P] [US3] Write failing system test for managed property CRUD in test/system/managed_properties_test.rb

### Implementation for User Story 3

- [ ] T067 [US3] Create app/controllers/managed_properties_controller.rb with CRUD actions
- [ ] T068 [US3] Add routes for managed_properties resource in config/routes.rb
- [ ] T069 [US3] Create app/policies/managed_property_policy.rb with organization scoping
- [ ] T070 [P] [US3] Create app/views/managed_properties/index.html.erb
- [ ] T071 [P] [US3] Create app/views/managed_properties/_form.html.erb with all fields per data-model.md
- [ ] T072 [P] [US3] Create app/views/managed_properties/show.html.erb
- [ ] T073 [P] [US3] Create app/views/managed_properties/new.html.erb
- [ ] T074 [P] [US3] Create app/views/managed_properties/edit.html.erb
- [ ] T075 [US3] Add managed_properties link to navigation in app/views/layouts/application.html.erb
- [ ] T076 [US3] Run bin/rails test to verify all US3 tests pass
